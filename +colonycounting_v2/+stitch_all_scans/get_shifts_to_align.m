    ...
    for i = 1:numel(stitch_info)
        ...
        for j = 1:numel(stitch_info(i).scan_info)
            ...
            if strcmp(answer, 'No, none do.')
                ...
                % get alignment:
                [shift_column, shift_row, image_height, image_width] = ...
                    colonycounting_v2.stitch_all_scans.get_shifts_to_align.get_shift(...
           ...
           stitch_info(i).scan_info(j).image_height = image_height;
           stitch_info(i).scan_info(j).image_width = image_width;
