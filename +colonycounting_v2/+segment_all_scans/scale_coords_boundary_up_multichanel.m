function boundaries = scale_coords_boundary_up_multichanel(boundaries, group, scale_rows, scale_columns)
    ...
    % scale colony boundaries for  group:
    boundaries.(group).colonies.stitch_original = scale_coords_boundary(boundaries.(group).colonies.stitch_small, scale_rows, scale_columns);
